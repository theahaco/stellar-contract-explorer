...
import { BASE_FEE, type contract } from "@stellar/stellar-sdk"
...
export const InvokeContractForm = ({
	...
	const { address: userPk, signTransaction, network } = useContext()
	...
	useEffect(() => {
		if (isSuccessfulSimulation) {
			const result = simulateTxData.result as Api.RawSimulateTransactionResponse
